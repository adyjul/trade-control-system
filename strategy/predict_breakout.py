...
# ------- CONFIG -------
MODEL_PATH = "/root/trade-control-system/strategy/ml/models/breakout_rf_model_xrpusdt_1h.pkl"
BACKTEST_GLOB = "/root/trade-control-system/backtest_result/hasil_backtest_xrpusdt_1h.xlsx"  # sesuaikan timeframe/pair jika perlu
